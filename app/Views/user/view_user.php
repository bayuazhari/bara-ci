			...
			<div class="panel panel-inverse">
				...
				<div class="panel-heading">
					...
					<?php if(@$checkLevel->create == 1){ ?>
						<a href="<?php echo base_url('user/add/'); ?>" class="btn btn-xs btn-circle btn-primary"><i class="fa fa-plus"></i> Add New</a>
						<a href="<?php echo base_url('user/bulk_upload/'); ?>" class="btn btn-xs btn-circle btn-success"><i class="fa fa-upload"></i> Bulk Upload</a>
					<?php } ?>
