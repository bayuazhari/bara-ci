						...
						<table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
							...
							?>
								<tr>
									...
									<td><?= $row->sdistrict_code ?></td>
									<td><?= $row->sdistrict_name ?></td>
									...
									<?php if(@$checkLevel->update == 1 OR @$checkLevel->delete == 1){ ?>
										<div class="btn-group">
											...
											<?php if(@$checkLevel->update == 1){ ?>
												<a href="<?php echo base_url('sub_district/edit/'.$row->sdistrict_id); ?>" class="dropdown-item"><i class="fa fa-edit"></i> Edit</a>
											<?php } if(@$checkLevel->delete == 1){ ?>
												<a href="javascript:;" class="dropdown-item <?php //if(@$model->getSubDistrictRelatedTable('sub_district', $row->sdistrict_id)){ echo 'disabled'; } ?>"  data-toggle="modal" data-target="#modal-delete" data-href="<?php echo base_url('sub_district/delete/'.$row->sdistrict_id) ?>"><i class="fa fa-trash-alt"></i> Delete</a>
											<?php } ?>
											</div>
										</div>
