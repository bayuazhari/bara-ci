		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<form action="<?php echo base_url('language/add') ?>" method="post">
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								<input type="text" class="form-control <?php if($error){ echo 'is-invalid'; } ?>" name="lang_code" value="<?= $request->getPost('lang_code'); ?>" />
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								<input type="text" class="form-control <?php if($error){ echo 'is-invalid'; } ?>" name="lang_name" value="<?= $request->getPost('lang_name'); ?>" />
								<?php if($error){ echo '<div class="invalid-feedback">'.$error.'</div>'; } ?>
							</div>
						</div>
