		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				...
				<!-- end panel-heading -->
				<?php
				$id = $menu_group->mgroup_id;
				if(@$request->getPost()){
					$mgroup_name = $request->getPost('mgroup_name');
					$status = $request->getPost('status');
				}else{
					$mgroup_name = $menu_group->mgroup_name;
					$status = $menu_group->mgroup_status;
				} ?>
				<!-- begin panel-body -->
				<div class="panel-body">
					<form action="<?php echo base_url('menu_group/edit/'.$id) ?>" method="post">
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								<input type="text" class="form-control <?php if($error){ echo 'is-invalid'; } ?>" name="mgroup_name" value="<?= $mgroup_name; ?>" />
