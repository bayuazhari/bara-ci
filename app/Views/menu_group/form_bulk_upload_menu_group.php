		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item"><a href="<?php echo base_url('menu_group') ?>"><?= $title ?></a></li>
			...
			<ul class="timeline">
				<li>
					...
					<div class="timeline-body">
						<div class="timeline-header">
							...
							<span class="views"><a href="<?php echo base_url('menu_group') ?>" class="btn btn-default btn-sm"><i class="fa fa-arrow-circle-left"></i> Back</a></span>
						</div>
						<div class="timeline-content">
							<a href="<?php echo base_url('assets/templates/menu_groups.csv') ?>" class="btn btn-info btn-block"><i class="fa fa-download"></i> Download CSV Template</a>
						</div>
					</div>
					<!-- end timeline-body -->
				</li>
				<li>
					...
					<div class="timeline-body">
						<div class="timeline-header">
							<span class="username">Add menu group info in CSV template</span>
						</div>
						<div class="timeline-content">
							<p>
							...
							<p>
								Description:<br>
								<strong>name</strong> - Menu group name (e.g., Dashboard).
							</p>
						</div>
					</div>
					<!-- end timeline-body -->
				...
				<li>
					...
					<div class="timeline-body">
						...
						<div class="timeline-content">
							<p>
								The upload menu groups file has fields separated by a comma only. The first line contains the valid field names. The rest of the lines (records) contain information about each menu group.<br>
						...
						<div class="timeline-comment-box">
							<div class="input">
								<form action="<?php echo base_url('menu_group/bulk_upload') ?>" method="post" enctype="multipart/form-data">
									<?php $error = $validation->getError('menu_group_csv'); ?>
									<div class="input-group">
										<input type="file" name="menu_group_csv" class="form-control rounded-corner <?php if($error){ echo 'is-invalid'; } ?>" />
				...
				<li>
					...
					<div class="timeline-body">
						...
						<div class="timeline-content">
							<form action="<?php echo base_url('menu_group/bulk_save') ?>" method="post">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-td-valign-middle">
									...
									?>
										<tr>
											<td class="<?php if($name_error == true){ echo 'bg-red text-white'; } ?>"><input type="hidden" name="menu_group[<?= $no ?>][mgroup_name]" value="<?= @$row['name'] ?>"><?= @$row['name'] ?></td>
										</tr>
									<?php $no++; } ?>
									</tbody>
								</table>
