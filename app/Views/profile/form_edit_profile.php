		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item"><a href="<?php echo base_url('profile') ?>"><?= $title ?></a></li>
					...
					<form action="<?php echo base_url('profile/edit/') ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group row m-b-0">
							<div class="col-md-12 col-sm-12 text-center">
								...
								<a href="<?php echo base_url('profile') ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> Back</a>
							</div>
						</div>
					</form>
				</div>
